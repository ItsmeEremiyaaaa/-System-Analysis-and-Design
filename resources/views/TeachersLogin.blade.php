...
<head>
  ...
  <title>Teacher Login - CLOT Admin</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    ...
    <!-- Top Bar -->
    <div class="top-bar">
      <a href="#" class="register-btn">Contact Administrator</a>
    </div>
    ...
    <div class="main-content">
      <div class="form-box">
        ...
        <form method="POST" action="{{ route('teacher.login.submit') }}">
          ...
          <button type="submit" class="btn">Log in to Dashboard</button>
        </form>
      ...
      <div class="illustration">
        <img src="{{ asset('FormDesign.png') }}" alt="Teaching Illustration" onerror="this.style.display='none'">
      </div>
    </div>
